...
mod lazy {
    ...
    pub static WORDLIST_ENGLISH: Lazy<WordList> = Lazy::new(|| { gen_wordlist(include_str!("langs/english.txt")) });
    #[cfg(feature = "chinese-simplified")]
    pub static WORDLIST_CHINESE_SIMPLIFIED: Lazy<WordList> = Lazy::new(|| { gen_wordlist(include_str!("langs/chinese_simplified.txt")) });
    #[cfg(feature = "chinese-traditional")]
    pub static WORDLIST_CHINESE_TRADITIONAL: Lazy<WordList> = Lazy::new(|| { gen_wordlist(include_str!("langs/chinese_traditional.txt")) });
    #[cfg(feature = "french")]
    pub static WORDLIST_FRENCH: Lazy<WordList> = Lazy::new(|| { gen_wordlist(include_str!("langs/french.txt")) });
    #[cfg(feature = "italian")]
    pub static WORDLIST_ITALIAN: Lazy<WordList> = Lazy::new(|| { gen_wordlist(include_str!("langs/italian.txt")) });
    #[cfg(feature = "japanese")]
    pub static WORDLIST_JAPANESE: Lazy<WordList> = Lazy::new(|| { gen_wordlist(include_str!("langs/japanese.txt")) });
    #[cfg(feature = "korean")]
    pub static WORDLIST_KOREAN: Lazy<WordList> = Lazy::new(|| { gen_wordlist(include_str!("langs/korean.txt")) });
    #[cfg(feature = "spanish")]
    pub static WORDLIST_SPANISH: Lazy<WordList> = Lazy::new(|| { gen_wordlist(include_str!("langs/spanish.txt")) });

    pub static WORDMAP_ENGLISH: Lazy<WordMap> = Lazy::new(|| { gen_wordmap(&WORDLIST_ENGLISH) });
    #[cfg(feature = "chinese-simplified")]
    pub static WORDMAP_CHINESE_SIMPLIFIED: Lazy<WordMap> = Lazy::new(|| {  gen_wordmap(&WORDLIST_CHINESE_SIMPLIFIED) });
    #[cfg(feature = "chinese-traditional")]
    pub static WORDMAP_CHINESE_TRADITIONAL: Lazy<WordMap> = Lazy::new(|| { gen_wordmap(&WORDLIST_CHINESE_TRADITIONAL) });
    #[cfg(feature = "french")]
